...
def generate_pptx(data: dict, plan: dict) -> bytes:
    ...
    bg.fill.solid(); bg.fill.fore_color.rgb = DONKER
    bg.line.fill.background()

    accent = slide.shapes.add_shape(1, 0, 0, Inches(0.4), prs.slide_height)
    accent.fill.solid(); accent.fill.fore_color.rgb = profiel_kleur
    ...
    run.font.size = Pt(32); run.font.bold = True; run.font.color.rgb = WIT
    ...
    r2.font.size = Pt(14); r2.font.color.rgb = MUTED
    ...
    for slide_idx in range(0, len(sel_items), ITEMS_PER_SLIDE):
        ...
        bg2.fill.solid(); bg2.fill.fore_color.rgb = DONKER
        ...
        for i, item in enumerate(batch):
            ...
            card.line.color.rgb = _hex("21262D"); card.line.width = Pt(0.5)
            ...
            top_bar.fill.solid(); top_bar.fill.fore_color.rgb = st_kleur
            ...
            nr.font.size = Pt(11); nr.font.bold = True; nr.font.color.rgb = WIT
            ...
            dr.font.size = Pt(8); dr.font.color.rgb = MUTED
            ...
            fr.font.size = Pt(8); fr.font.color.rgb = st_kleur
